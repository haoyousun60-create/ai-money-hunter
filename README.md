...
<p align="center">
  ...
  <br>
  <em>Built in public · Updated weekly</em>
</p>
...
2. Perform testnet tasks (swap, stake, bridge, etc.)
...
- Social media automation (post, engage, grow accounts)
...
### Key Principles
1. **Start before you're ready** — Submit PRs early, iterate fast
2. **Build in public** — Share your progress, gain recognition
3. **Focus on one platform** — Master Superteam or Algora first
4. **Compounding** — Each bounty = easier next bounty (reputation)
